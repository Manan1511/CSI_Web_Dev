    ...
    return (
        <div className="group relative mb-4 flex items-start">
            <textarea
                ...
                className={`w-full resize-none outline-none bg-transparent overflow-hidden px-4 py-3 rounded hover:bg-gray-50 transition-colors ${block.type === 'h1' ? 'text-4xl font-bold mb-4 placeholder-gray-300 min-h-[3rem]' :
            ...
            <div className="ml-2 mt-3 opacity-0 group-hover:opacity-100 flex items-center transition-opacity">
                <button
